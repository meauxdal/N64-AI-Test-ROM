...
Because the N64 Audio Interface uses a clock divider, sample rate targets are approximate. The actual value written to the AI_DACRATE and AI_BITRATE registers equal the corresponding values in the above table, minus 1.
